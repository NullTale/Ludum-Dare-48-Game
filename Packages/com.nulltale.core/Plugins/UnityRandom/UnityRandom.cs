...
public class UnityRandom : IRandomGenerator
{
	...
	// 
	public static WeightedRandomCollection<T> CreateWeightedBag<T>(IEnumerable<T> values, Func<T, float> initalWeights, IRandomGenerator randomGenerator = null)
    {
		var result = new WeightedRandomCollection<T>(randomGenerator);
	...
	{
		return new Vector2Int(UnityEngine.Random.Range(xRange.x, xRange.y), UnityEngine.Random.Range(yRange.x, yRange.y));
	}

	public static Vector2Int Vector2Int(int xMax, int yMax)
	{
		return new Vector2Int(UnityEngine.Random.Range(0, xMax), UnityEngine.Random.Range(0, yMax));
	}
	...
	public static Vector2 Vector2(float xMagnitude, float yMagnitude)
	{
		...
		return new Vector2(UnityEngine.Random.Range(-xHalf, xHalf), UnityEngine.Random.Range(-yHalf, yHalf));
	}
	...
	public static Vector3 Vector3(float xMagnitude, float yMagnitude, float zMagnitude)
	{
		...
		return new Vector3(UnityEngine.Random.Range(-xHalf, xHalf), UnityEngine.Random.Range(-yHalf, yHalf), UnityEngine.Random.Range(-zHalf, zHalf));
	}
    ...
    /*public static Vector3 Normal3D(float xyDeg, float zDeg, float range)
    {
