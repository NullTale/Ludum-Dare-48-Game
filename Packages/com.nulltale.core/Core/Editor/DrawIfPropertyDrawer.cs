            ...
            foreach (var copareData in drawIf.m_CompareList)
            {
                ...
                { // Possible extend cases to support your own type
                    case SerializedPropertyType.Boolean:
                        if (comparedField.boolValue.Equals(copareData.m_PropertyValue) == false)
                            return false;
                        break;
                    case  SerializedPropertyType.Enum:
                        if (comparedField.enumValueIndex.Equals((int)copareData.m_PropertyValue) == false)
                            return false;
                        break;
                    case  SerializedPropertyType.ObjectReference:
                        if ((comparedField.objectReferenceValue == (Object)copareData.m_PropertyValue) == false)
                            return false;
                        break;
                    default:
