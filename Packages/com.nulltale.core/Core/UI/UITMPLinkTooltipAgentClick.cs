    ...
    public class UITMPLinkTooltipAgentClick : UITMPLinkTooltip.UITMPLinkTooltipAgent, IPointerClickHandler
    {
        ...
        public override void Init(UITMPLinkTooltip owner, TextMeshProUGUI text)
        {
            ...
            m_Camera = canvas != null
                ? canvas.renderMode == RenderMode.ScreenSpaceOverlay ? null : global::CoreLib.Core.Instance.Camera
        ...
        {
            var linkID = TMP_TextUtilities.FindIntersectingLink(m_Text, PointerPosition.Instance.ScreenPosition, m_Camera);
            if (linkID != -1)
            {
                ...
                if (m_OnUpdate == null)
                {
                    ...
                    m_OnUpdate.Action = () =>
                    {
                        var currentLinkID = TMP_TextUtilities.FindIntersectingLink(m_Text, PointerPosition.Instance.ScreenPosition, m_Camera);
