...
namespace CoreLib
{
    ...
    public class DrawIfAttribute : PropertyAttribute
    {
        ...
        public DrawIfAttribute(DisablingType disablingType, string comparedPropertyNameA, object comparedValueA, string comparedPropertyNameB, object comparedValueB)
        {
            m_CompareList = new List<CompareData>(new []{new CompareData(comparedPropertyNameA, comparedValueA), new CompareData(comparedPropertyNameB, comparedValueB)});
            m_DisablingType = disablingType;
        }
